...
- Each course is scraped once every ~8 minutes. This is currently dependent on the number of courses that I need to scrape. My tracker waits 3 seconds between requests, and there are 161 sections, so there is a delay of roughly 8.05 seconds (plus some more).
